...
func initCDPSurface(c *ModCDPClient) {
	c.Accessibility = AccessibilityDomain{client: c}
	c.Animation = AnimationDomain{client: c}
	c.Audits = AuditsDomain{client: c}
	c.Autofill = AutofillDomain{client: c}
	c.BackgroundService = BackgroundServiceDomain{client: c}
	c.BluetoothEmulation = BluetoothEmulationDomain{client: c}
	c.Browser = BrowserDomain{client: c}
	c.CSS = CSSDomain{client: c}
	c.CacheStorage = CacheStorageDomain{client: c}
	c.Cast = CastDomain{client: c}
	c.Console = ConsoleDomain{client: c}
	c.DOM = DOMDomain{client: c}
	c.DOMDebugger = DOMDebuggerDomain{client: c}
	c.DOMSnapshot = DOMSnapshotDomain{client: c}
	c.DOMStorage = DOMStorageDomain{client: c}
	c.Debugger = DebuggerDomain{client: c}
	c.DeviceAccess = DeviceAccessDomain{client: c}
	c.DeviceOrientation = DeviceOrientationDomain{client: c}
	c.Emulation = EmulationDomain{client: c}
	c.EventBreakpoints = EventBreakpointsDomain{client: c}
	c.Extensions = ExtensionsDomain{client: c}
	c.FedCm = FedCmDomain{client: c}
	c.Fetch = FetchDomain{client: c}
	c.FileSystem = FileSystemDomain{client: c}
	c.HeadlessExperimental = HeadlessExperimentalDomain{client: c}
	c.HeapProfiler = HeapProfilerDomain{client: c}
	c.IO = IODomain{client: c}
	c.IndexedDB = IndexedDBDomain{client: c}
	c.Input = InputDomain{client: c}
	c.Inspector = InspectorDomain{client: c}
	c.LayerTree = LayerTreeDomain{client: c}
	c.Log = LogDomain{client: c}
	c.Media = MediaDomain{client: c}
	c.Memory = MemoryDomain{client: c}
	c.Network = NetworkDomain{client: c}
	c.Overlay = OverlayDomain{client: c}
	c.PWA = PWADomain{client: c}
	c.Page = PageDomain{client: c}
	c.Performance = PerformanceDomain{client: c}
	c.PerformanceTimeline = PerformanceTimelineDomain{client: c}
	c.Preload = PreloadDomain{client: c}
	c.Profiler = ProfilerDomain{client: c}
	c.Runtime = RuntimeDomain{client: c}
	c.Schema = SchemaDomain{client: c}
	c.Security = SecurityDomain{client: c}
	c.ServiceWorker = ServiceWorkerDomain{client: c}
	c.SmartCardEmulation = SmartCardEmulationDomain{client: c}
	c.Storage = StorageDomain{client: c}
	c.SystemInfo = SystemInfoDomain{client: c}
	c.Target = TargetDomain{client: c}
	c.Tethering = TetheringDomain{client: c}
	c.Tracing = TracingDomain{client: c}
	c.WebAudio = WebAudioDomain{client: c}
	c.WebAuthn = WebAuthnDomain{client: c}
}
